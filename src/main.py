...
# Generate dataset
# generate_dataset(10000, 2000)

# Train model
train_spacy("src/spaCy/model", "src/spaCy/optimizer.pkl", "src/dataset/train_dataset.json", "src/dataset/validation_dataset.json", 50, 16, 2)
