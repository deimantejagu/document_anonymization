...
# Generate dataset
# generate_dataset(30000, 5000)

# Train model
train_spacy("src/spaCy/model", "src/spaCy/optimizer.pkl", "src/dataset/train_dataset.json", "src/dataset/validation_dataset.json", 100, 16, 2)
